                    ...
                    <form action="{{ route('owner.products.update', ['product' => $product->id]) }}" method="POST">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="relative">
                                ...
                                value="{{ $quantity }}" >
                                <div class="w-full bg-gray-100 bg-opacity-50 rounded border">{{ $quantity }}</div>
                            </div>
                        </div>
                        <div class="p-2 w-1/2 mx-auto">
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                                            ...
                                            <optgroup label="{{ $category->name }}">
                                                @foreach ($category->secondary as $secondary)
                                                    <option value="{{ $secondary->id }}" 
                                                        @if ( $secondary === $product->secondary_category_id)
                                                            selected
                                                        @endif>
                                                        {{ $secondary->name }}
                                                    </option>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div><input type="radio" name="is_selling" value="1" class="mr-2" @if ($shop->id->is_selling === 1) checked @endif>販売中</div>
                                    <div><input type="radio" name="is_selling" value="0" class="mr-2" @if ($shop->id->is_selling === 0) checked @endif>停止中</div>
                                </div>
                            </div>
